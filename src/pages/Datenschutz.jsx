      ...
      <ContentContainer>
        <CenteredText>
          ...
          <p>
            ...
            „Fairstofft!“ und unserer Webseite. Datenschutz hat einen hohen
            Stellenwert für uns. Im Folgenden informieren wir Sie ausführlich
          ...
          <address>
            Florian Bowitz
            <br />
            Fairstofft! – Verein für Kleiderspenden e.V.
            <br />
            Musterstraße 1<br />
          ...
          <p>
            Beim Besuch unserer Website werden automatisch Daten wie IP-Adresse,
            verwendeter Browser, Datum und Uhrzeit des Zugriffs protokolliert.
            Diese Daten dienen ausschließlich der Sicherstellung eines
            störungsfreien Betriebs und der Verbesserung unseres Angebots. Eine
          ...
          <p>
            ...
            speichern. Sollte dies in Zukunft der Fall sein, werden wir Sie
            gesondert darüber informieren.
          </p>

          <h3>4. Nutzung von Social Media und Drittanbieter-Diensten</h3>
          <p>
            Unsere Webseite verzichtet bewusst auf eingebundene
            Social-Media-Plugins oder externe Tracking-Dienste, um Ihre Daten zu
            schützen.
          </p>
          ...
          <ul style={{ listStylePosition: "inside" }}>
            ...
            <li>
              Sie können die Berichtigung, Löschung oder Einschränkung der
          ...
          <p>
            ...
            anzupassen, um sie aktuellen rechtlichen Anforderungen anzupassen
