      ...
      <ContentContainer>
        <CenteredText>
          ...
          <p>
            ...
            Dritter sind entsprechend gekennzeichnet. Die Vervielfältigung,
          ...
          <p>
            Texte auf dieser Website wurden teilweise mit Unterstützung von
            ChatGPT (OpenAI) erstellt und redaktionell angepasst.
          </p>

          <h3>Bildnachweis</h3>
          <p>
            Die verwendeten Bilder stammen von Unsplash.com und sind unter der
            Unsplash‑Lizenz frei verwendbar.
            <br />
            Beispiele:
            <br />
          </p>
          <p>
            Unsplash / Foto:{" "}
            <a href="https://unsplash.com/photos/person-holding-white-clothes-hanger-aAVVmgod3N4">
              aAVVmgod3N4
            </a>
          </p>
          <p>
            Weitere Bildquellen werden direkt am Bild oder in den Alt‑Attributen
            angegeben.
          </p>
