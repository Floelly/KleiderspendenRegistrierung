...
const sortedLocations = [...new Set(locations)].sort((a, b) =>
    ...
    <FormGrid noValidate onSubmit={handleSubmit(onSubmit)}>
...

      {
        ...
        mode === "Abholung (Sammelfahrzeug)" && (
          <>
            ...
            {errors.houseNumber && (
              <ErrorP>{errors.houseNumber.message}</ErrorP>
            )}
            ...
            {errors.additionalInfo && (
              <ErrorP>{errors.additionalInfo.message}</ErrorP>
            )}
          </>
        )
      }
      ...
      <GridLabel>
        ...
        <Select required {...register("clothes")}>
          ...
          <option value="Oberteile (T‑Shirts, Blusen, Hemden)">
          ...
          <option value="Gemischte Kleiderspende">
            Gemischte Kleiderspende
          </option>
        </Select>
      </GridLabel>
